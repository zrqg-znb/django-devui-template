...
from .serializers import (
    ScriptTaskSerializer, ScriptExecutionSerializer,
...
class ScriptTaskView(APIView):
    ...
    @swagger_auto_schema(
        ...
        operation_description="获取所有脚本任务，支持按状态和类型筛选",
        manual_parameters=[
    ...
    def get(self, request):
        ...
        queryset = ScriptTaskService.get_all_scripts(status=status, script_type=script_type)
...
class ScriptExecutionView(APIView):
    ...
    @swagger_auto_schema(
        ...
        operation_description="获取脚本执行记录，可按脚本筛选",
        manual_parameters=[
    ...
    def get(self, request):
        ...
        if script_id:
            queryset = ScriptExecutionService.get_executions_by_script(script_id)
        else:
            queryset = ScriptExecutionService.get_all_executions()
